...
public class CompletableFutrueComposeExample {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException, TimeoutException {
        CompletableFuture<Integer> completableFutureBigCompute = CompletableFuture.supplyAsync(() -> {
// big computation
            return 10;
        });
...
// big computation
    ...
    private static CompletableFuture<Double> continueWithVeryImportantThing(Integer str) {
        if ("10".equals(str))
